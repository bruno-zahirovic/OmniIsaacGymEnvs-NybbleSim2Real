...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "nybble_non_normalized_inputs_pth"
...
#define AI_NETWORK_IN_1_CHANNEL     (36)
#define AI_NETWORK_IN_1_SIZE        (36)
#define AI_NETWORK_IN_1_SIZE_BYTES  (144)
